...
### 🔧 What I Do
- Learning and building **CI/CD pipelines** for automated build & deployment  
- Working with **Docker** to containerize applications  
- Exploring **Cloud (AWS basics)** and Linux system operations  
- Implementing **monitoring & reliability** using Prometheus and Grafana  

---

### 🛠 Tech Stack
- **Languages:** Java, Python, C++  
- **DevOps & Cloud:** Git, GitHub, GitHub Actions, Docker, AWS (EC2, IAM, S3 – basics)  
...
![Shell Scripting](https://img.shields.io/badge/Shell_Scripting-4EAA25?style=for-the-badge&logo=gnu-bash)
...
- Linux scripting & system reliability  
...
### 🌐 Connect With Me
- 📧 Email: satyaprakash.6ckp@gmail.com  
- 🔗 GitHub: https://github.com/Satyaverma25  
- 💼 LinkedIn: https://www.linkedin.com/in/satya-prakash25  
